...
vim.keymap.set("n", "<C-h>", ":nohl<CR>", { desc = "Clear search highlight", silent = true })
vim.keymap.set("n", "<C-c>", ":lua vim.snippet.stop()<CR>", { desc = "Clear tabstop", silent = true})
...
vim.keymap.set("n", "<F9>", function()
  ...
  -- Open the vertical split terminal first
